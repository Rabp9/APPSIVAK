...
class ReporteController extends BaseController
{
	...
	public function actionTicket($codigoReciboVenta)
	{
		...
		$html=''.
			...
			'<body style="font-size: 10px;">'.
				'<img id="imgLogo" src="img/logoCliente.png" height="60" style="border-right: 1px solid #999999;left: 0px;position: fixed;top: 0px;">'.
				'<div id="divTipoComprobante" style="font-size: 25px;left: 230px;position: fixed;top: 20px;">TICKET</div>'.
				'<div style="display: inline-block;font-size: 12px;left: 230px;position: fixed;top: 55px;">'.$codigoReciboVenta.'</div>'.
				'<div id="divFechaEmision" style="left: 210px;position: fixed;top: 0px;">Generado el: '.date('d-m-Y H:i:s').'</div>'.
				'<div id="divSeparadorCabecera" style="background-color: #999999;left: 0px;height: 1px;position: fixed;top: 75px;width: 375px;"></div>'.
	            '<table cellpadding="0" cellspacing="0" style="left: 0px;position: fixed;top: 85px;width: 390px;">'.
	                '<tbody>'.
                        '<tr>'.
                            '<td class="bold" style="width: 110px;">'.('Local:').'</td>'.
                            '<td>'.iconv('UTF-8', 'windows-1252', $tReciboVenta->tOficina->descripcion).'</td>'.
                        '</tr>'.
						
						'<tr>'.
                            '<td class="bold" style="width: 110px;">'.('Cliente:').'</td>'.
                            '<td>'.iconv('UTF-8', 'windows-1252', $tReciboVenta->nombreCompletoCliente).'</td>'.
                        '</tr>'.
						
                        '<tr>'.
                            '<td class="bold" style="width: 110px;">Tipo de pago:</td>'.
                            '<td>'.iconv('UTF-8', 'windows-1252', $tReciboVenta->tipoPago).'</td>'.
                        '</tr>'.
                        '<tr>'.
                            '<td class="bold" style="width: 110px;">Fecha de venta:</td>'.
                            '<td>'.iconv('UTF-8', 'windows-1252', substr($tReciboVenta->fechaComprobanteEmitido, 0, 10)).'</td>'.
                        '</tr>'.
	                '</tbody>'.
	            '</table>'.
	            '<table class="tabla" style="left: 0px;position: fixed;top: 135px;width: 390px;">'.
            		'<thead>'.
            			'<tr>'.
                            ('<th class="textAlignLeft">'.iconv('UTF-8', 'windows-1252', 'Descripción').'</th>').
                            ('<th class="textAlignCenter" style="width: 20px;">Cant.</th>').
	                		('<th class="textAlignCenter" style="width: 65px;">Precio U.</th>').
	                		('<th class="textAlignCenter" style="width: 65px;">Total</th>').
		                '</tr>'.
            		'</thead>'.
            		'<tbody>';
				        foreach($tReciboVenta->tReciboVentaDetalle as $value)
				        {
							$html.=''.
							'<tr>'.
	                			'<td class="" style="textAlignLeft">'.iconv('UTF-8', 'windows-1252', $value->primerNombreProducto.' / '.$value->segundoNombreProducto.' / '.$value->tercerNombreProducto).'</td>'.
	                			'<td class="bordeDotted textAlignCenter">'.($value->cantidadProducto).'</td>'.
	                			'<td class="bordeDotted textAlignCenter">S/. '.($value->precioVentaUnitarioProducto).'</td>'.
	                			'<td class="bordeDotted textAlignCenter">S/. '.number_format($value->precioVentaTotalProducto, 2, '.', '').'</td>'.
	                		'</tr>';
				        }
    					$html.=''.
						'<tr>'.
                			'<td colspan="2" class="bold"></td>'.
                			'<td class="bold textAlignRight">Total</td>'.
                			'<td class="bold bordeDotted textAlignCenter">S/. '.$tReciboVenta->total.'</td>'.
                		'</tr>'.
                		'<tr>'.
	...
	public function actionBoleta($codigoReciboVenta)
	{
		...
		$html=''.
			...
			'<body style="font-size: 14px;">'.
				'<div style="display: inline-block;font-size: 11px;left: 640px;position: fixed;top: 20px;">'.$codigoReciboVenta.'</div>'.
		...
		return Response::make(PDF::load($html, 'A4', 'portrait')->show('my_pdf'));
	}
	...
	public function actionFactura($codigoReciboVenta)
	{
		...
		$html=''.
			...
			'<body style="font-size: 15px;">'.
				'<div style="display: inline-block;font-size: 13px;left: 660px;position: fixed;top: 2px;">'.$codigoReciboVenta.'</div>'.
	            '<div id="divCliente" style="left: 140px;position: fixed;top: 175px;">'.iconv('UTF-8', 'windows-1252', $tReciboVenta->nombreCompletoCliente).'</div>'.
				'<div id="divDocumento" style="left: 140px;position: fixed;top: 197px;">'.($tReciboVenta->documentoCliente).'</div>'.
	            '<div id="divDireccion" style="left: 140px;position: fixed;top: 222px;">'.iconv('UTF-8', 'windows-1252', $tReciboVenta->direccionCliente).'</div>'.
	            '<div id="divFechaEmision" style="left: 635px;position: fixed;top: 220px;">'.substr($tReciboVenta->fechaComprobanteEmitido, 0, 10).'</div>'.
	            '<div id="divComprobanteDetalle" style="left: 60px;position: fixed;top: 260px;">'.
	            	'<table>'.
	            		'<tbody>';
	                    foreach($tReciboVenta->tReciboVentaDetalle as $value)
	                    {
							$html.=''.
							'<tr>'.
	                			'<td class="textAlignCenter" style="width: 80px;">'.($value->cantidadProducto).'</td>'.
	                			'<td class="textAlignCenter" style="width: 80px;">'.iconv('UTF-8', 'windows-1252', $value->unidadMedidaProducto).'</td>'.
	                			'<td class="" style="width: 450px;">'.iconv('UTF-8', 'windows-1252', $value->primerNombreProducto.' / '.$value->segundoNombreProducto.' / '.$value->tercerNombreProducto).'</td>'.
	                			'<td class="textAlignCenter" style="width: 100px;">'.($value->precioVentaUnitarioProducto).'</td>'.
	                			'<td class="textAlignCenter" style="width: 100px;">'.number_format($value->precioVentaTotalProducto, 2, '.', '').'</td>'.
	                		'</tr>';
	                    }
						$html.=''.
	        			'</tbody>'.
	            	'</table>'.
	            '</div>'.
	            '<div id="divTotalLetras" style="left: 120px;position: fixed;top: 485px;">'.iconv('UTF-8', 'windows-1252', $convertirNumeroLetra->ValorEnLetras(($tReciboVenta->total),"")).'</div>';
	            if($tReciboVenta->tipoPago=='Al Contado')
	            {
	            	$html.=''.
	            	'<div id="divFechaCancelacion" style="left: 335px;position: fixed;top: 510px;">'.date('d-m-Y').'</div>';
	            }
	            $html.=''.
	            '<div id="divSubTotal" style="left: 480px;position: fixed;top: 525px;">'.($tReciboVenta->subTotal).'</div>'.
	            '<div id="divIgv" style="left: 580px;position: fixed;top: 525px;">'.($tReciboVenta->igv).'</div>'.
	...
	public function actionProforma()
	{
		...
		$html=''.
			...
			'<body style="font-size: 14px;">'.
				'<img id="imgLogo" src="img/logoCliente.png" height="54" style="border-right: 1px solid #999999;left: 0px;position: fixed;top: 0px;">'.
				'<div id="divTipoComprobante" style="font-size: 32px;left: 270px;position: fixed;top: 10px;">COTIZACIÓN</div>'.
				'<div id="divFechaEmision" style="left: 525px;position: fixed;top: 0px;">Generado el: '.date('d-m-Y H:i:s').'</div>'.
				'<div id="divSeparadorCabecera" style="background-color: #999999;left: 0px;height: 1px;position: fixed;top: 60px;"></div>'.
				...
				'<div id="divDireccion" style="left: 0px;position: fixed;top: 100px;"><div style="display: inline-block;width: 80px;"><b>'.iconv('UTF-8', 'windows-1252', 'Direccción:').'</b></div>'.iconv('UTF-8', 'windows-1252', $direccionCliente).'</div>'.
