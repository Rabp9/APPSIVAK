...
<script>
    function enviarFrmVentaEntreFechasPorCodigoOficina()
    {
        ...
        window.open('/APPSIVAK/public/reporte/ventaentrefechasporcodigooficinatiporecibo/'+$('#txtCodigoOficina').val()+'/'+$('#txtFechaInicial').val()+'/'+$('#txtFechaFinal').val()+'/'+$('#cbxTipoRecibo').val(), '_blank');
    }
</script>