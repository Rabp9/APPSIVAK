...
@section('contenidoCuerpo')
    <h2 class="textAlignRight bordeAbajo tituloCabecera">REGISTRAR OFICINA</h2>
    <section class="contenidoTop">
        <form id="frmInsertarOficina" action="/APPSIVAK/public/oficina/insertar" method="post" class="formulario labelMediano">
            <div class="contenidoTop textAlignLeft">
                <h2 class="bordeAbajo">Datos de la oficina</h2>
            ...
            <div class="seccionBotones bordeArriba">
                <input type="button" value="Registrar" onclick="enviarFrmInsertarOficina();">
            </div>
        </form>
    </section>
    <script>
        function enviarFrmInsertarOficina()
        {
            ...
            if(confirm('Realmente desea registrar la Oficina'))
            {        
                $('#frmInsertarOficina').submit();
                return;
            }
